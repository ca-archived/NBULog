...
#define COCOAPODS_VERSION_PATCH_CocoaLumberjack 5
...
#define COCOAPODS_VERSION_PATCH_CocoaLumberjack_Core 5
...
#define COCOAPODS_VERSION_PATCH_CocoaLumberjack_Extensions 5
